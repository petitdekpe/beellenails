...
class PaymentChoiceController extends AbstractController
{
    ...
    public function choosePayment(Rendezvous $rendezvous, PaymentMethodRepository $paymentMethodRepository, BookingSettingsRepository $bookingSettingsRepository): Response
        {
            ...
            return $this->render('payment_choice/index.html.twig', [
                ...
                'holdDurationMinutes' => $bookingSettingsRepository->getHoldDurationMinutes(),
            ]);
        }
}