...
class PaymentFeexController extends AbstractController
{
    ...
    public function storePhoneNumber(Request $request, SessionInterface $session, Rendezvous $rendezvou): Response
    {
        ...
        return $this->redirectToRoute('payment_feex_init', ['rendezvou' => $rendezvou->getId()]);
    }

    #[Route('/rendezvous/{rendezvou}/payment/feex/init', name: 'payment_feex_init')]
    ...
    #[Route('/rendezvous/payment/callback/feex/{reference}', name: 'payment_callback_feex', methods: ['POST'])]
